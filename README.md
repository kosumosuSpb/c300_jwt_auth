...
Доступно через PATCH запрос к `/auth/api/v1/permissions/<name:str>`
...
Доступно через DELETE запрос к `/auth/api/v1/permissions/<name:str>`
...
* добавить ручки на редактирование и удаление пользователей и профилей пользователей
...
* понять как решить проблему с правами на папки service_data, logs и их содержимое
