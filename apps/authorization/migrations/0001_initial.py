...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('create', 'CREATE'), ('read', 'READ'), ('update', 'UPDATE'), ('delete', 'DELETE')], max_length=6)),
                ('name', models.CharField(max_length=150)),
                ('description', models.CharField(blank=True, max_length=255, null=True)),
                ('companies', models.ManyToManyField(related_name='permissions', to='authorization.companyprofile')),
                ('tenants', models.ManyToManyField(related_name='permissions', to='authorization.tenantprofile')),
                ('workers', models.ManyToManyField(related_name='permissions', to='authorization.workerprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ManyToManyField(related_name='permissions_groups', to='authorization.permissionmodel')),
            ],
        ),
        migrations.CreateModel(
            name='OwnerArea',
